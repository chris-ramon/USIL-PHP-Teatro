...
var Obras={initialize:function(a){this.config=a;this.bindEvents();this.start_wookmark()},bindEvents:function(){this.config.login_button.on("click",this.showLoginForm);this.config.close_login_wrapper_btn.on("click",this.closeLoginWrapper)},showLoginForm:function(){var b=Obras;var a=b.config.login_wrapper.data("status");if(a=="inactive"){b.config.login_wrapper.slideDown("fast")}else{b.config.login_wrapper.hide()}a=(a=="inactive")?"active":"inactive";b.config.login_wrapper.data("status",a)},closeLoginWrapper:function(a){$(this).parent().parent().data("status","inactive").hide();a.preventDefault()},start_wookmark:function(){var a={autoResize:true,container:$("#obras"),offset:20};var b=$(".thumbnails li");b.wookmark(a)}};